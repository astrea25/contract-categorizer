...
const NotificationDropdown: React.FC = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const fetchedNotifications = await getNotifications(role, { limit: 10 });
                ...
                >
                  <div className="flex justify-between items-start mb-1">
                    <h4 className="text-sm font-medium">
                      {notification.type === 'contract_created' ? 'New Contract' :
                       notification.type === 'contract_requested' ? 'Contract Requested' :
                       'Notification'}
                    </h4>
