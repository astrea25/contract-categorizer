              ...
              {sortedComments.map((comment) => (
                <div key={comment.id} className="space-y-3">
                  ...
                  {comment.replies && comment.replies.length > 0 && (
                    <div className="ml-11 border-l-2 pl-4 border-border/50 space-y-4 mt-3">
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. The comment and any replies will be permanently deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
