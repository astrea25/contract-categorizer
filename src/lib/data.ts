// Contracts at contract_end stage
// Contracts in review stages
...
// Email of the recipient for notifications
// Optional reference to the folder ID
// Flag to indicate if contract is archived
// When the contract was archived
// Who archived the contract
// Timestamp of the last activity on the contract
// Legacy field: Number of days of inactivity before sending a notification
// Number of business days of inactivity for reviewers/approvers before sending a notification
// Number of business days of inactivity for regular users before sending a notification
// Amendment tracking
// Flag to indicate if contract has been amended
// Current stage in the amendment process
// Original status before amendment started
// Type-specific fields
// Supporting documents checklist
// Timeline and comments
// Added optional user name for display
...
// Use email username or 'User' as fallback
...
// Different lengths
// Assume different if error occurs
...
// User has been deleted and is not allowed to access the application
...
// Compare dates by converting to simple date strings (YYYY-MM-DD)
// Continue with other filters if date comparison fails
// Include the contract if there's an error
...
// Default role
// Flag to indicate that the user needs to change their password
...
// Mark as active user, not pending
// Flag to indicate that the user needs to change their password on first login
...
// This will need to be manually updated by admin
...
// First check if the user is in the deleted_users collection
// User has been deleted and should not be able to reset password
// Check admin collection
// User is an admin
// Check users collection
// User exists if the snapshot is not empty
...
// System Settings
// Number of days to keep archived contracts before deletion
// Whether automatic deletion is enabled
// Timestamp of last update
// Email of user who last updated settings
