...
const SystemSettingsPage = () => {
  ...
  const handleRetentionDaysChange = (value: string) => {
    ...
    if (!isNaN(numValue)) {
      setSettings({ ...settings, archiveRetentionDays: numValue });
    } else if (value === '') {
      setSettings({ ...settings, archiveRetentionDays: 0 });
    }
  };

  // Toggle auto-delete
  const handleToggleAutoDelete = (checked: boolean) => {
    setSettings({ ...settings, autoDeleteEnabled: checked });
  };
          ...
          <>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure how long archived contracts are retained before permanent deletion
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Automatically delete archived contracts after the retention period
                      </p>
                    </div>
                    <Switch 
                      id="auto-delete" 
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Archived contracts will be permanently deleted after this many days
                    </p>
                  </div>
                ...
                <div className="space-y-2">
                  <p className="text-sm">
                    ...
                    {settings.autoDeleteEnabled 
                      ? `Archived contracts will be permanently deleted after ${settings.archiveRetentionDays} days` 
                      : 'Automatic deletion of archived contracts is disabled'}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Note: Permanently deleted contracts cannot be recovered. Make sure any important contract data 
